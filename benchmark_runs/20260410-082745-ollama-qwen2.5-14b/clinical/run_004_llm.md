...
question = [
    'Q1 [Single-hop retrieval]: What is the allergy flag currently recorded for subject PT-2247? Answer with the exact flag value only. Do not explain.',
    'Q2 [Distractor robustness]: Three records reference subject identifiers close to PT-2247: PT-2241, PT-2274, and PT-2247-SCREEN. What is the allergy flag for PT-2247 (the enrolled subject record, not the screening record)? Answer with the exact flag value only.',
    'Q3 [Misleading fact resistance]: The document mentions an earlier allergy entry for PT-2247 that was corrected. What is the CURRENT allergy flag in the enrolled subject record for PT-2247, as it appears in the main patient record? Answer with the exact flag value only.',
...
# Extract relevant information based on questions from `context`
Q1 = "PCN-HIGH"
Q2 = "PCN-HIGH"
Q3 = "PCN-HIGH"
...
Q5 = ("PT-2247 is receiving Compound VX-7 in the high dose of 80mg."
       " The Phase I safety review committee recommended continued monitoring "
       "of renal function markers for subjects in the high-dose arm."
       " Therefore, ongoing protocol action should apply enhanced renal monitoring to PT-2247.")

final_answer = f"Q1: {Q1}\nQ2: {Q2}\nQ3: {Q3}\nQ4: {Q4}\nQ5: {Q5}"
print(final_answer)
```
...
LATENCY BREAKDOWN
======================================================================
  Total wall time:    262.634s

======================================================================
TOKEN USAGE
======================================================================
qwen2.5:14b: input=1,645, output=1,645, calls=1
======================================================================
```
