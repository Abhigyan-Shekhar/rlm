...
Traceback (most recent call last):
  File "/Users/abhigyanshekhar/Desktop/RLM-FULL/llm-test/test_stochastic_tsp_adaptive_llm_only.py", line 7, in <module>
    run_path(str(repo_root / "test_stochastic_tsp_adaptive_llm_only.py"))
  File "<frozen runpy>", line 291, in run_path
  File "<frozen runpy>", line 98, in _run_module_code
  File "<frozen runpy>", line 88, in _run_code
  File "/Users/abhigyanshekhar/Desktop/RLM-FULL/test_stochastic_tsp_adaptive_llm_only.py", line 51, in <module>
...
openai.RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama-3.3-70b-versatile` in organization `org_01knvqnv0nf8gvs5df8h9xn8c4` service tier `on_demand` on tokens per day (TPD): Limit 100000, Used 99891, Requested 1583. Please try again in 21m13.536s. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
