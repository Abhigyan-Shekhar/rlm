...
│ the `SHOW_VARS()` function to check what variables are available and then    │
...
│ understand what information we have at our disposal for answering the query. │
│                                                                              │
│ ```repl                                                                      │
│ print(context)                                                               │
│ ```                                                                          │
│                                                                              │
│ Once I review the context, I can determine the appropriate approach to solve │
│ the problem. If necessary, I'll use `llm_query`, `rlm_query`, or break down  │
│ the context further into manageable chunks using `llm_query_batched` or      │
│ `rlm_query_batched`.                                                         │
│                                                                              │
│ ~60 words                                                                    │
╰──────────────────────────────────────────────────────────────────────────────╯
...
╭─ ◇ LLM Response  (3.96s) ────────────────────────────────────────────────────╮
│ Let's start by inspecting the content of the `context` variable to           │
│ understand what information we have available for this query. I will use the │
│ `SHOW_VARS()` function to print out all variables created so far.            │
│ ```repl                                                                      │
│ SHOW_VARS()                                                                  │
│ ```                                                                          │
│                                                                              │
...
LATENCY BREAKDOWN
======================================================================
  Total wall time:          52.092s
  RLM execution time:       50.212s
  Overhead (wait/setup):    1.881s
...
======================================================================
  ...
  ----------------------------------------
     ...
     ms per output token:  256.2 ms/tok
     Total tokens/sec:     207.2 tok/s
======================================================================
```
