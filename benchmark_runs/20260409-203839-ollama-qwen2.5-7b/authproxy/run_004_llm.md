...
If AuthProxy-Primary fails, it does not trigger a failover because the FAILOVER_ENABLED value for AuthProxy-Primary is false.

======================================================================
LATENCY BREAKDOWN
======================================================================
  Total wall time:    20.940s

======================================================================
TOKEN USAGE
======================================================================
qwen2.5:7b: input=1,082, output=150, calls=1
======================================================================
```
