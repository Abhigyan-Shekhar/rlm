...
If AuthProxy-Primary fails, failover is not enabled. Therefore, there would be no automatic switch to another instance as the FAILOVER_ENABLED value is set to false.

======================================================================
LATENCY BREAKDOWN
======================================================================
  Total wall time:    21.342s
